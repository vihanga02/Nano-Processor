...
HD_PWD='C:/Users/workshop/Documents/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplier_4.tcl
