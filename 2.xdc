...
set_property PACKAGE_PIN V14 [get_ports {Log_and_Shift_out[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Log_and_Shift_out[3]}]
set_property PACKAGE_PIN V13 [get_ports {Log_and_Shift_out[8]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Log_and_Shift_out[8]}]
set_property PACKAGE_PIN V3 [get_ports {Log_and_Shift_out[9]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Log_and_Shift_out[9]}]
set_property PACKAGE_PIN W3 [get_ports {Log_and_Shift_out[10]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Log_and_Shift_out[10]}]
