...
HD_PWD='/home/vihangamuthumala/Documents/my_work/Nano-Processor/Nano-Processor/Nano-Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Process.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Process.tcl -notrace
